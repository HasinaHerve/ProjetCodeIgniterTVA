...
<body style=" font-family: 'Times New Roman', 'Times', 'serif';font-size:14px">
    ...
    <!-- Brand/logo -->
		...
		<!-- Links -->
        <button style="z-index:1" class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar" onmouseover="document.getElementById('menu').src='../../../image/menu.png'" onclick="document.getElementById('menu').src='../../../image/menu.png'" onmouseout="document.getElementById('menu').src='../../../image/menu1.png'">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav" style="padding-left:70px;;font-size:1.5vw">
				<li class="nav-item">
                    <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Voir toutes les listes des déclarations, personnels, contribuables, comptes contribuables, comptes administrateurs" class="active" href="#" ><h5 style="color:white"><img src="../../../image/liste1.png" id="liste" alt="">Toutes les listes</h5></a>
				</li>
				<li class="nav-item">
        ...
        <div class="shadow p-4 mb-4 bg-white" style="background-color:white;border-radius:5px;padding-top:10px;padding-left:5px;padding-right:5px;padding-bottom:5px;color:#006622">
            ...
            <?php 
                $alert=$this->session->flashdata('alertSupp');
                    ...
                    ?>
            <?php 
                $alert=$this->session->flashdata('alertModifPers');
                    if($alert!=""){
                    ?>
                        <div class="alert alert-success alert-dismissible fade show" style="margin-right:45px">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                    ...
                    ?>
            <?php 
                $alert=$this->session->flashdata('alertSuppPers');
                    if($alert!=""){
                    ?>
                        <div class="alert alert-danger alert-dismissible fade show" style="margin-right:45px">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
            ...
            $alert=$this->session->flashdata('alertSuppC');
                ...
                ?>
            <div class="row">
                <div id="c1" class="column" onclick="openTab('b1');document.getElementById('c1').style.background='white';document.getElementById('c2').style.background='#e6e6e6';document.getElementById('c3').style.background='#e6e6e6';document.getElementById('c4').style.background='#e6e6e6';document.getElementById('c5').style.background='#e6e6e6'" style="border:solid 1.5px #e6e6e6;border-bottom:none;border-left:none;background-color:white">
                    Listes des déclarations
                </div>
                <div id="c2" class="column" onclick="openTab('b2');document.getElementById('c2').style.background='white';document.getElementById('c1').style.background='#e6e6e6';document.getElementById('c3').style.background='#e6e6e6';document.getElementById('c4').style.background='#e6e6e6';document.getElementById('c5').style.background='#e6e6e6'" style="border:solid 1.5px #e6e6e6;border-bottom:none;border-left:solid 1.5px white;">
                    Listes des personnels
                </div>
                <div id="c3" class="column" onclick="openTab('b3');document.getElementById('c3').style.background='white';document.getElementById('c2').style.background='#e6e6e6';document.getElementById('c1').style.background='#e6e6e6';document.getElementById('c4').style.background='#e6e6e6';document.getElementById('c5').style.background='#e6e6e6'" style="border:solid 1.5px #e6e6e6;border-bottom:none;border-left:solid 1.5px white;">
                    Listes des contribuables
                </div>
                <div id="c4" class="column" onclick="openTab('b4');document.getElementById('c4').style.background='white';document.getElementById('c2').style.background='#e6e6e6';document.getElementById('c3').style.background='#e6e6e6';document.getElementById('c1').style.background='#e6e6e6';document.getElementById('c5').style.background='#e6e6e6'" style="border:solid 1.5px #e6e6e6;border-bottom:none;border-left:solid 1.5px white;">
                    Listes des comptes contribuables
                </div>
                <div id="c5" class="column" onclick="openTab('b5');document.getElementById('c5').style.background='white';document.getElementById('c2').style.background='#e6e6e6';document.getElementById('c3').style.background='#e6e6e6';document.getElementById('c4').style.background='#e6e6e6';document.getElementById('c1').style.background='#e6e6e6'" style="border:solid 1.5px #e6e6e6;border-bottom:none;border-right:none;border-left:solid 1.5px white;">
                    Listes des comptes personnels
                </div>
            </div>

            <div id="b1" class="containerTab">
                <div class="table-responsive">
                    <table class="table table-hover" id="listeDec">
                        <thead>
                        <tr>
                            <th>NumDec</th>
                            <th>Nif</th>
                            ...
                            if (!empty($dec)) {
                                    foreach ($dec as $dec) {?>
                                        <tr>
                                            ...
                                            <td><?php if($dec['validation']=="oui"){echo "<img data-toggle='tooltip' data-placement='bottom' title='Validée' src='../../../image/oui.png' alt=''>";}
                                            else{
                                                echo "<img data-toggle='tooltip' data-placement='bottom' title='Non validée' src='../../../image/no.png' alt=''>";
                                            }
            ...
            <div id="b2" class="containerTab" style="display:none;">
                <div class="table-responsive">
                    <table class="table table-hover" id="listePers">
                        <thead>
                        <tr>
                            <th>Im</th>
                            <th>Cin</th>
                            ...
                            if (!empty($pers)) {
                                    foreach ($pers as $pers) {?>
                                        <tr>
                                            ...
                                            <td><?php echo $pers['cinP']?></td>
                                            <td><?php echo $pers['nomP']?></td>
                                            <td><?php echo $pers['prenomsP']?></td>
                                            <td><?php echo $pers['fonction']?></td>
                                            <td><?php echo $pers['dateNaissP']?></td>
                                            <td><?php echo $pers['sexeP']?></td>
                                            <td><?php echo $pers['sm']?></td>
                                            <td><?php echo $pers['communeP']?></td>
                                            <td><?php echo $pers['adresseP']?></td>
                                            <td><?php echo $pers['telP']?></td>
                                            <form method="POST" action=<?php echo base_url().'Controlleur/modifPers'?> >
                                                <td><button type="submit" class="btn btn-info" value="modifier" style="font-size:14px" name=<?php echo "m".$pers['im']?>>Modifer</button></td>
                                                <td><button type="submit" class="btn btn-danger" value="supprimer" style="font-size:14px" name=<?php echo "s".$pers['im']?>>Supprimer</button></td>
                                            </form>
                                            <td><?php echo $this->Model->centreN1($pers['idCentre'])['nomCentre']?></td>
            ...
            <div id="b3" class="containerTab" style="display:none;">
                <div class="table-responsive">
                    <table class="table table-hover" id="listeC">
                        <thead>
                        <tr>
                            <th>Nif</th>
                            <th>type</th>
            ...
            <div id="b4" class="containerTab" style="display:none;">
                <div class="table-responsive">
                    <table class="table table-hover" id="listeCompteC">
                        <thead>
                        <tr>
                            <th>Nif</th>
                            <th>Mot de passe</th>
                        ...
                        <tbody style="color:#737373">
                            <?php 
                            if (!empty($compteC)) {
                                    foreach ($compteC as $compteC) {?>
                                        <tr>
                                            <td><?php echo $compteC['nif']?></td>
                                            <td><?php echo $compteC['mdpC']?></td>   
                                        </tr>
                                    <?php
                                    }
                                }?>
            ...
            <div id="b5" class="containerTab" style="display:none;">
                <div class="table-responsive">
                    <table class="table table-hover" id="listeCompteP">
                        <thead>
                        <tr>
                            <th>Immatricule</th>
                            <th>Mot de passe</th>
                        ...
                        <tbody style="color:#737373">
                            <?php 
                            if (!empty($compteP)) {
                                    foreach ($compteP as $compteP) {?>
                                        <tr>
                                            <td><?php echo $compteP['im']?></td>
                                            <td><?php echo $compteP['mdpP']?></td>   
                                        </tr>
                                    <?php
                                    }
                                }?>
...
<script>
    ...
    $('#listeCompteP').DataTable({

    });
    $('#listeCompteC ').DataTable({
