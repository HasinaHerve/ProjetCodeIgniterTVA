...
<body style=" font-family: 'Times New Roman', 'Times', 'serif';font-size:14px">
    ...
    <div class="container-fluid" style="padding-top:80px;">
        <div class="centre shadow p-4 mb-4 bg-white" id="etape1" style="background-color:white;border-radius:5px;padding-left:50px;padding-right:0px;padding-bottom:5px;">
            <?php 
                $alert=$this->session->flashdata('alertErreurC');
                    ...
                    ?>
            <p style="border-bottom:2px solid #006622;width:48.5%;font-size:18px;color:#006622">Etape 1: Informations sur le contribuable</p></br>
            <form class="form-horizontal" name="form" method="POST" action=<?php echo base_url().'Controlleur/ajoutC';?>>
			  	<div class="form-group">
                    ...
                    <div class="row" >
						<div class="col-8" style="">
							...
							<input type="text" class="form-control" onkeypress="return event.charCode>=48 && event.charCode<=57" maxlength="10" placeholder="Numéro téléphone mobile" name="tel" value="<?php echo $this->session->flashdata('telC');?>">	
                            <span class="container text-left">
        ...
        <div class="centre shadow p-4 mb-4 bg-white" id="etape2" style="background-color:white;border-radius:5px;display:none;padding-left:50px;padding-right:0px;padding-bottom:5px;">
            <p style="border-bottom:2px solid #006622;width:41%;font-size:18px;color:#006622">Etape 2: informations sur l'activité</p></br>
