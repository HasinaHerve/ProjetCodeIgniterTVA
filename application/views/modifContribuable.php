...
<nav class="navbar navbar-expand-sm fixed-top" style="background-color:#006622;">
    <!-- Brand/logo -->
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav" style="padding-left:70px;;font-size:1.5vw">
				<li class="nav-item">
                    <a onmouseover="document.getElementById('liste').src='../../../image/liste1.png'" onclick="document.getElementById('personnel').src='../../../image/liste1.png'" onmouseout="document.getElementById('liste').src='../../../image/liste0.png'" class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Voir toutes les listes des déclarations, personnels, contribuables, comptes contribuables, comptes administrateurs" href=<?php echo base_url().'Controlleur/acceuilAdmin'?> ><h5><img src="../../../image/liste0.png" id="liste" alt="">Toutes les listes</h5></a>
				</li>
				<li class="nav-item">
    ...
    <div class="container-fluid" style="padding-top:80px;">
        <div class="centre shadow p-4 mb-4 bg-white" id="etape1" style="background-color:white;border-radius:5px;padding-left:50px;padding-right:0px;padding-bottom:5px;">
            <p style="border-bottom:2px solid #006622;width:59%;font-size:18px;color:#006622">Modification des informations sur le contribuable</p></br>
			  	...
			  	<div class="form-group">
                    ...
                    <div class="row" >
						<div class="col-8" style="">
							...
							<input type="text" class="form-control" placeholder="Nom du personnel" name="nom" value=<?php echo $this->session->flashdata('nomC');?>>
                            <span class="container text-left">
                    ...
                    <div class="row" >
						<div class="col-8" style="">
                            ...
                            <select name="sm" class="custom-select mb-3 form-control">
                                <option <?php echo $this->session->flashdata('Célibataire');?>>Célibataire</option>
                                <option <?php echo $this->session->flashdata('Marié(e)');?>>Marié(e)</option>
                                <option <?php echo $this->session->flashdata('Dicorcé(e)');?>>Dicorcé(e)</option>
                                <option <?php echo $this->session->flashdata('Veuf(ve)');?>>Veuf(ve)</option>
                    ...
                    <div class="row" >
						<div class="col-8" style="">
							...
							<input type="text" class="form-control" placeholder="Numéro téléphone mobile" name="tel" value=<?php echo $this->session->flashdata('telC');?>>	
                            <span class="container text-left">
                    ...
                    <div class="row">
                        <div class="col-12" style="text-align:right;padding-right:20px;">
                            <button type="submit" class="btn btn-success" name="suivant" value="suivant">Suivant<img class="img-fluid" src="../../../image/next1.png"></button>	        
                        </div>
                    </div>
        ...
        <div class="centre shadow p-4 mb-4 bg-white" id="etape2" style="background-color:white;border-radius:5px;display:none;padding-left:50px;padding-right:0px;padding-bottom:5px;">
            <p style="color:#006622;border-bottom:2px solid #006622;width:51.25%;font-size:18px">Modification des informations sur l'activité</p></br>
...
<script>
    ...
    function verifMdp(){
		if(document.forms['form']['nmdp'].value.length<5){
