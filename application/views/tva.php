...
<body onload="nan()" style=" font-family: 'Times New Roman', 'Times', 'serif';font-size:14px">
    ...
    <!-- Brand/logo -->
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav" style="padding-left:70px;;font-size:1.5vw">
				<li class="nav-item">
                    <a onmouseover="document.getElementById('liste').src='../../../image/liste1.png'" onclick="document.getElementById('liste').src='../../../image/liste1.png'" onmouseout="document.getElementById('liste').src='../../../image/liste0.png'" class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Voir toutes les listes des déclarations" href=<?php echo base_url().'Controlleur/acceuilContribuable'?>><h5><img src="../../../image/liste0.png" id="liste" alt="">Toutes les listes</h5></a>
				</li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Faire une déclaration" href="#"><h5 style="color:white">Déclaration</h5></a>
                </li>
			</ul>
    ...
    <div class="container-fluid" style="padding-top:80px;padding-left:80px;padding-right:80px;">
        <div class="dropdown dropleft" id="num" style="position:fixed;right:5px;z-index:1" onmouseover="document.getElementById('help').src='../../../image/help1.png'" onclick="document.getElementById('help').src='../../../image/help1.png'" onmouseout="document.getElementById('help').src='../../../image/help0.png'">
                <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Aide" href=<?php echo base_url().'Controlleur/aide'?> target="_blank"><img src="../../../image/help0.png" id="help" alt=""></a>
        </div>
    
    <form name="form1" action=<?php echo base_url().'Controlleur/declarationtva';?> method="POST">
    <div id="rs" class="shadow p-4 mb-4 bg-white" style="background-color:white;border-radius:5px;padding-top:10px;padding-bottom:5px;">
        <span style="color:#999999;font-size:16px"><span style="color:#006622">Activité</span> - Opération - Déduction - Enregistrement</span>
        <div class="row">
            <div class="col-4" style="text-align:right">
            </div>
            <div class="col-8" style="text-align:right;padding-right:7%">
            <?php $this->load->model('Model');
            $dec=$this->Model->dernierDec();
            if($dec==null){
                $num=1;
            }
            else{
            ...
            if(!$this->session->userdata('modifDec')=="oui"){
                echo ("Déclaration n°:".$num);
                $this->session->set_flashdata('numDec',$num);
            }
            else{
                echo ("Déclaration n°:".$this->session->userdata('numDec1'));
            }
        ...
        <div class="row">
            <div class="col-12" style="text-align:right;padding-right:20px;">
                <span onclick="verifA();" class="btn btn-success calculer">Suivant<img class="img-fluid" src="../../../image/next1.png"></span>
            </div>
        </div>
    </div><br>
    ...
    <div>
        ...
        " style="background-color:white;border-radius:5px;padding-top:30px;padding-left:5%;padding-right:5%;padding-bottom:5px;color:#006622">
            <div class="shadow p-4 mb-4 bg-white" id="op" style="display:none">
                <span style="color:#999999;font-size:16px">Activité - <span style="color:#006622">Opération</span> - Déduction - Enregistrement</span>
                <br><br>
                <table class="table table-bordered">
                    <thead style="text-align:center">
                    <tr>
                        <th rowspan="2"><h5 style="color:#006622">OPERATIONS</h5></th>
                    ...
                    <tr>
                        <td style="border:none;text-align:left">
                            <span onclick="document.getElementById('op').style.display='none';document.getElementById('rs').style.display='block'" class="btn btn-secondary calculer"><img src="../../../image/prev.png" alt="" >Précédent</span>
                        </td>
                        ...
                        <td style="border:none;text-align:right">
                            <span onclick="calculer();" class="btn btn-success calculer">Suivant<img class="img-fluid" src="../../../image/next1.png"></span>
                        </td>
                    </tr>
                    </tbody>
            ...
            <div class="shadow p-4 mb-4 bg-white" id="ded" style="display:none">
                <span style="color:#999999;font-size:16px">Activité - Opération - <span style="color:#006622">Déduction</span> - Enregistrement</span>
                <br><br>
                <table class="table table-bordered">
                    <thead style="text-align:center">
                    <tr>
                        <th ><h5 style="color:#006622">DEDUCTIONS</h5></th>
                        <th >Locaux <br>(f)</th>
                    ...
                    <tr>
                        <td style="border-right:none">
                            <form name="form1" class="form-inline">
                                <div class="form-group"><label>8-Prorata de déduction</label><input name="prorata" value="<?php echo $this->session->flashdata("prorata");?>" style="width:10%;border:none;border-bottom:2px solid #999999" placeholder=".........">%TVA déductible de la période((7) x taux prorata)): 
                    ...
                    <tr>
                        <td style="border:none;text-align:left">
                            <span onclick="document.getElementById('ded').style.display='none';document.getElementById('op').style.display='block';" class="btn btn-secondary calculer"><img src="../../../image/prev.png" alt="" >Précédent</span>
                        </td>
                        <td style="border:none"></td>
                        <td style="border:none"></td>
                        <td style="border:none;text-align:right">
                            <span onclick="calculer1();document.getElementById('ded').style.display='none';document.getElementById('tv').style.display='block';document.getElementById('bt').style.display='block'" class="btn btn-success calculer">Suivant<img class="img-fluid" src="../../../image/next1.png"></span>
                        </td>
                    </tr>
                    </tbody>
                </table>
            </div>
            <div class="shadow p-4 mb-4 bg-white" id="tv" style="display:none">
                <span style="color:#999999;font-size:16px">Activité - Opération - Déduction - <span style="color:#006622">Enregistrement</span></span>
                <br><br>
                <table class="table table-bordered">
                    <tr>
                    ...
                    <tr>
                        <td style="border:none;text-align:left">
                            <span onclick="document.getElementById('tv').style.display='none';document.getElementById('ded').style.display='block';" class="btn btn-secondary calculer"><img src="../../../image/prev.png" alt="" >Précédent</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="border:none;text-align:left">
                            <a onmouseover="verifTous()"  data-toggle="tooltip" data-placement="bottom" title="Veuiller enregistrer avant d'imprimer" href="<?php echo base_url().'Controlleur/impression';?>" target="_blank" class="btn btn-secondary">Imprimer <img class="img-fluid" src="../../../image/imprimer.png"></a>
                        </td>
                        <td style="border:none"></td>
                        <td style="border:none"></td>
                        <td style="border:none"></td>
                        ...
                        <td style="border:none;">
                            <button formaction="<?php echo base_url().'Controlleur/tva';?>" class="btn btn-danger" >Annuler <img class="img-fluid" src="../../../image/cancel.png"></button>
                        </td>
                        <td style="border:none;text-align:right">
                            <button onmouseover="verifTous()" class="btn btn-success" id="enregistrer" name="enregistrer" value="enregistrer">Enregistrer <img class="img-fluid" src="../../../image/yes.png"></button>	        
                        </td>
                    </tr>
                </table>
            </div>            
...
function calculer(){
    ...
    if(!document.forms['form1']['oppat'].value=="" && document.forms['form1']['taux1'].value==""){
    ...
    else if(document.forms['form1']['oppat'].value=="" && !document.forms['form1']['taux1'].value==""){
        document.getElementById('oppat').focus();
    }
    else if(!document.forms['form1']['oppnat'].value=="" && document.forms['form1']['taux2'].value==""){
        document.getElementById('taux2').focus();
    }
    else if(document.forms['form1']['oppnat'].value=="" && !document.forms['form1']['taux2'].value==""){
        document.getElementById('oppnat').focus();
    }
    else if(!document.forms['form1']['ataxable'].value=="" && document.forms['form1']['taux3t'].value==""){
        ...
        document.getElementById('op').style.display='none';document.getElementById('ded').style.display='block';
    }
