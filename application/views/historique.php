...
<nav class="navbar navbar-expand-sm fixed-top" style="background-color:#006622;">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav" style="padding-left:70px;;font-size:1.5vw">
                ...
                <li class="notification">
                    <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Voir touts les historiques des utilisateurs" href="#"><h5><img src="../../../image/notif1.png" id="notif" alt=""><span class="badge">
                    <?php 
                        if (!empty($count)) {
                            echo $count['hist'];
                        }
    ...
    <div class="container-fluid" style="padding-top:80px;">
        ...
        <form action="<?php echo base_url().'Controlleur/rechercher'?>" method="POST">
            <div class="row">
                <div class="col-md-2">
        ...
        <br><br>
        <form action="<?php echo base_url().'Controlleur/lu'?>" method="POST">
