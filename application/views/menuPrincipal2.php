    ...
    <!-- Brand/logo -->
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav" style="padding-left:70px;">
				...
				<li class="nav-item">
					<a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Espace reservée aux contribuables ayant un numéro d'identification fiscal(NIF)"  href="#"><h5 style="color:white">Espace contribuable</h5></a>
				</li>
	...
	<div class="container-fluid" style="padding-top: 85px;">
	  	<div class="row" >	
		    ...
		    <div class="col-md-10" id="ea" style="height: 700px;padding-left: 31.25%;padding-right: 5.25%;padding-top: 20px">
				...
				<div style="padding-top:5px;padding-left:95%;display:none"><div class="spinner-border text-success"></div></div>
					<h4 style="color:#006622"><img class="img-fluid" src="../../../image/aut.png">Authentification</h4></br>
					<?php 
						$alert=$this->session->flashdata('errnif');
							if($alert!=""){
							?>
							...
							?>
					<form method="POST" action=<?php echo base_url().'Controlleur/connexionC';?>>
		    		<div class="form-group">
				    	<div class="row">
							<label class="control-label col-md-4" for="nomU">Nif:</label>
						    <div class="col-8" style="column-width: 400px;">
						    	<input type="text" onkeypress="return event.charCode>=48 && event.charCode<=57" maxlength="8" class="form-control" placeholder="Numéro d'identification fiscal" name="connif" value="<?php echo $this->session->flashdata('connif');?>">	
								<span class="container text-left">
					    			<label class="control-label text-danger"><?php echo form_error('connif'); ?></label> 
					    		</span>		    
						    </div>
					    </div></br>
				    	<div class="row">
					    	...
					    	<div class="col-8" style="column-width: 400px;">          
					        	<input type="password" maxlength="12" class="form-control" id="pwdl" placeholder="Entrez votre mot de passe" name="conmdpc" <?php echo $this->session->flashdata('focus');?> value="<?php echo $this->session->flashdata('conmdpc');?>"> 
								<span class="container text-left">
					    			<label class="control-label text-danger"><?php echo form_error('conmdpc'); ?></label> 
					    		</span>
								<span class="container text-center">
					    			<label class="control-label text-danger"><?php echo $this->session->flashdata('errmdpc');?></label> 
					    		</span>
					...
					<div class="row">
				        ...
				        <div class="col-md-9" style="font-size: 14px;text-align:right">
				        	...
				        	<button class="btn btn-secondary esp1" name="creer" value="creer" style="border-color: #999999;width:52%;font-size:1.20vw" data-toggle="modal" data-target="#Modal2">Créer un compte <img src="../../../image/add20.png"></button>
				        </div>
...
<form class="form-horizontal" name="form" method="POST" action=<?php echo base_url().'Controlleur/ajoutCompteC';?>>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title" style="color: #006622"><img class="img-fluid" src="../../../image/addUser.png" >Création(compte contribuable)</h4>
		...
		<?php 
			$alert=$this->session->flashdata('alertAjoutCC');
				if($alert!=""){
				?>
				...
				?>
		<?php 
			$alert=$this->session->flashdata('alertErreurCC');
				if($alert!=""){
				?>
	        ...
	        <div class="container text-center" style="border: 1px solid #006622;border-radius: 5px;"><br>
			  	<div class="form-group">
					<div class="row">
						<label class="control-label col-4" for="nomU" style="">NIF:</label>
						<div class="col-8" style="column-width: 400px;">
							<input onkeypress="return event.charCode>=48 && event.charCode<=57" maxlength="8" type="text" class="form-control" placeholder="Numéro d'identification fiscal" name="nif" value="<?php echo $this->session->flashdata('nif');?>">	
                            <span class="container text-left">
					    		<label class="control-label text-danger"><?php echo form_error('nif'); ?></label> 
					    	</span>				    
						</div>
					</div></br>
					<div class="row">
						...
						<div class="col-8" style="column-width: 400px;">          
						    <input type="password" class="form-control" id="mdp" placeholder="Entrez votre mot de passe" name="mdpc" value="<?php echo $this->session->flashdata('mdpc');?>"></br>
                            <span class="container text-left">
					    		<label class="control-label text-danger"><?php echo form_error('mdpc'); ?></label> 
					    	</span>	
						  	<input onclick="verifMdp()" type="password" class="form-control" id="pwdl" placeholder="Confirmation du mot de passe" name="cmdpc" value="<?php echo $this->session->flashdata('cmdpc');?>">	
                            <span class="container text-left">
					    		<label class="control-label text-danger"><?php echo form_error('cmdpc'); ?></label> 
					    	</span>		        	
						</div>
...
<?php 
    if($this->session->flashdata('affCC')==="afficher"){
        echo "<script>
            $('#Modal2').modal('show');
            </script>";
    }
...
function verifMdp(){
	if(document.forms['form']['mdpc'].value.length<5){
